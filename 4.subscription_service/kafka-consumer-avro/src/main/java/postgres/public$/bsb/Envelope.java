...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public postgres.public$.bsb.Value before;
  @Deprecated public postgres.public$.bsb.Value after;
   ...
   */
  public Envelope(postgres.public$.bsb.Value before, postgres.public$.bsb.Value after, io.debezium.connector.postgresql.Source source, java.lang.String op, java.lang.Long ts_ms, io.confluent.connect.avro.ConnectDefault transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (postgres.public$.bsb.Value)value$; break;
    case 1: after = (postgres.public$.bsb.Value)value$; break;
   ...
   */
  public postgres.public$.bsb.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(postgres.public$.bsb.Value value) {
    this.before = value;
  }
   ...
   */
  public postgres.public$.bsb.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(postgres.public$.bsb.Value value) {
    this.after = value;
  }
   ...
   */
  public static postgres.public$.bsb.Envelope.Builder newBuilder() {
    return new postgres.public$.bsb.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static postgres.public$.bsb.Envelope.Builder newBuilder(postgres.public$.bsb.Envelope.Builder other) {
    if (other == null) {
      return new postgres.public$.bsb.Envelope.Builder();
    } else {
      return new postgres.public$.bsb.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static postgres.public$.bsb.Envelope.Builder newBuilder(postgres.public$.bsb.Envelope other) {
    if (other == null) {
      return new postgres.public$.bsb.Envelope.Builder();
    } else {
      return new postgres.public$.bsb.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private postgres.public$.bsb.Value before;
    private postgres.public$.bsb.Value.Builder beforeBuilder;
    private postgres.public$.bsb.Value after;
    private postgres.public$.bsb.Value.Builder afterBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(postgres.public$.bsb.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = postgres.public$.bsb.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = postgres.public$.bsb.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(postgres.public$.bsb.Envelope other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.public$.bsb.Envelope.Builder setBefore(postgres.public$.bsb.Value value) {
     ...
     * @return This builder.
     */
    public postgres.public$.bsb.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(postgres.public$.bsb.Value.newBuilder(before));
        } else {
          setBeforeBuilder(postgres.public$.bsb.Value.newBuilder());
        }
      }
    ...
    public postgres.public$.bsb.Envelope.Builder setBeforeBuilder(postgres.public$.bsb.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.public$.bsb.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.public$.bsb.Envelope.Builder setAfter(postgres.public$.bsb.Value value) {
     ...
     * @return This builder.
     */
    public postgres.public$.bsb.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(postgres.public$.bsb.Value.newBuilder(after));
        } else {
          setAfterBuilder(postgres.public$.bsb.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public postgres.public$.bsb.Envelope.Builder setAfterBuilder(postgres.public$.bsb.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.public$.bsb.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.public$.bsb.Envelope.Builder setSource(io.debezium.connector.postgresql.Source value) {
    ...
    public postgres.public$.bsb.Envelope.Builder setSourceBuilder(io.debezium.connector.postgresql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.public$.bsb.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.public$.bsb.Envelope.Builder setOp(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.public$.bsb.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.public$.bsb.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.public$.bsb.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.public$.bsb.Envelope.Builder setTransaction(io.confluent.connect.avro.ConnectDefault value) {
    ...
    public postgres.public$.bsb.Envelope.Builder setTransactionBuilder(io.confluent.connect.avro.ConnectDefault.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public postgres.public$.bsb.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (postgres.public$.bsb.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (postgres.public$.bsb.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new postgres.public$.bsb.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new postgres.public$.bsb.Value();
        }
